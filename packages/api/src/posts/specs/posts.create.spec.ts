...
describe('POSTS controller CREATE', () => {
  ...
  it('/users POST, should return 400 more than required field', async () => {
  ...
  it('/users POST, should return 400 because file is missing in storage', async () => {
    const postDto: PostCreateDto = {
      videoId: 'test',
      description: 'test',
      geoPoint: {
  ...
  it('/users POST, should return 200', async () => {
